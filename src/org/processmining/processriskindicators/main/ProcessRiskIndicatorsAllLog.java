...
public class ProcessRiskIndicatorsAllLog {
...
if(ip.configure)
{
	...
	testLog = func.getOneDataSetRisks(context,log,ip);
...
}else
{
	...
	context.log("Identifying risks");	
	testLog = func.getRunRisks(context,inputlog, startTimeslot, endTimeslot, dist, allstDev, stDev, ip);	
